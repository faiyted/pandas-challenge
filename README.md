...
**Draws two correct conclusions or comparisons from the calculations
    ...
    -2. Schoold size also has huge impact on passing rate in general. When school size is large size(2000-5000), the overall passing rate drops significantly. Large school size are often under district school type
